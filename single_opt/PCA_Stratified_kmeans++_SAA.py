...
# Apply PCA
pca = PCA(n_components=0.99)  # Choose the number of components for PCA
...
cluster = KMeans(n_clusters=SS_SAA, init='k-means++', random_state=0).fit(demand_pca)
...
#     elapsed_time_df=elapsed_time_df,
#     start_row=1,
#     sheet_name='result'
# )
